        ...
        <div className="row">
          <div className="col col-2">
            ...
            <ul className='mt-4'>
              ...
              <li className='p-3 mt-3 fs-5' onClick={handleAddDoctor}><i class="ri-file-user-line p-3" onClick={handleAddDoctor}></i>Add Doctor</li>
              <li className='p-3 mt-3 fs-5'><i class="ri-file-user-line p-3" ></i>Doctor List</li>
            </ul>
          ...
          <div className="col col-10 d-flex flex-column">
            ...
            <div className='border border-3 d-flex justify-content-between flex-column'>
              <h5 className='m-3 text-primary'><span className='text-secondary'>Admin / </span> Doctor List</h5>
