        ...
        <div className="row">
          <div className="col col-2">
            ...
            <ul className='mt-4'>
              ...
              <li className='p-3 mt-3 fs-5'><i class="ri-file-user-line p-3" ></i>Add Doctor</li>
          ...
          <div className="col col-10 d-flex flex-column">
            ...
            <div className='border border-3 d-flex justify-content-between flex-column'>
              <h5 className='m-3 text-primary'><span className='text-secondary'>Admin / </span> Add Doctor</h5>
